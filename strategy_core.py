...
# min from midnight). Validated on the 215-trade month + 24h/72h windows; re-confirmed
# on 05-27..05-29 (cutoff-off added 3 afternoon entries, all losers: +38%→+25% expectancy).
SKIP_OPEN_MINUTES = 0
